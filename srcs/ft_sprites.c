...
/*   Updated: 2021/04/25 22:03:53 by ymehdi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_sprite_aux(t_get *get)
{
  ...
  get->sprite.spritescreenx = (int)((get->rx / 2) * (1 + get->sprite.transformx
  			/ get->sprite.transformy));
...
void ft_dist_order(t_get *get)
{
  ...
  while (i < get->sprite.numspr)
  {
    ...
    get->sprite.dist[i] = ((get->ray.posx - get->sxy[i].x) * (get->ray.posx - \
